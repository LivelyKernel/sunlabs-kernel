...
exec java -Djava.ext.dirs=$fxlib/shared:$fxlib/desktop -classpath $lib/js.jar:$lib/jline.jar:. jline.ConsoleRunner com.sun.javafx.runtime.Main org.mozilla.javascript.tools.shell.Main $*
