...
exec java -javaagent:rhinifier.jar -Djava.ext.dirs=$fxlib/shared:$fxlib/desktop:ext -classpath $lib/js.jar:$lib/jline.jar:. jline.ConsoleRunner com.sun.javafx.runtime.Main org.mozilla.javascript.tools.shell.Main -version 170  $*
