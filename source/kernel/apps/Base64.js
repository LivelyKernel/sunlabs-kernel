module('apps.Base64').requires().toRun(function() {
...
/* Modified by Tilman Giese to fit to Lively Kernel */

Object.subclass("Base64", {});

Object.extend(Base64, {
	...
	encode: function (str) {
		...
		while(i < length) {
			...
			if(i == length) {
				...
				out.push(this.encodeChars.charCodeAt(c1 >> 2));
				out.push(this.encodeChars.charCodeAt((c1 & 0x3) << 4));
			...
			if(i == length) {
				...
				out.push(this.encodeChars.charCodeAt(c1 >> 2));
				out.push(this.encodeChars.charCodeAt(((c1 & 0x3)<< 4) | ((c2 & 0xF0) >> 4)));
				out.push(this.encodeChars.charCodeAt((c2 & 0xF) << 2));
				out.push("=".charCodeAt(0));
				break;
			}
			...
			out.push(this.encodeChars.charCodeAt(c1 >> 2));
			out.push(this.encodeChars.charCodeAt(((c1 & 0x3)<< 4) | ((c2 & 0xF0) >> 4)));
			out.push(this.encodeChars.charCodeAt(((c2 & 0xF) << 2) | ((c3 & 0xC0) >>6)));
			out.push(this.encodeChars.charCodeAt(c3 & 0x3F));
		}
